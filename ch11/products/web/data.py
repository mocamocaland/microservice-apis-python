...
suppliers = [
    ...
    {
        'id': '92f2daae-a4f8-4aae-8d74-51dd74e5de6e',
        'name': 'Honey Supplier',
        'address': '99 honey Way',
        'contactNumber': '0987654321',
        'email': 'homey@honeysupplier.com',
    },
]
...
ingredients = [
    ...
    {
        'id': '602f2ab3-97bd-468e-a88b-bb9e00531fx1',
        'name': 'Honey',
        'stock': {
            'quantity': 200.00,
            'unit': 'LITERS',
        ...
        'products': [],
        'supplier': '92f2daae-a4f8-4aae-8d74-51dd74e5de6e',
        'lastUpdated': datetime.utcnow(),
    },
]
